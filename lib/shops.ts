/**
 * Shop → domain map for the curated shops, used to build a Clearbit logo URL
 * (https://logo.clearbit.com/<domain>) as an image fallback on product cards.
 * Unknown shops fall back to a slugified "<name>.com".
 */
const SHOP_DOMAINS: Record<string, string> = {
  ...
  "club l london": "clublondon.com",
  "club l": "clublondon.com",
