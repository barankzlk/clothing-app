...
export const en = {
  ...
  search: {
    ...
    liveResults: "{total} products found for “{query}”",
    searching: "Searching…",
    searchFailed: "Search failed. Please try again.",
    introTitleNamed: "What are you after, {name}?",
    introTitle: "What are you after?",
    introBody:
      "Describe a piece in your own words, or pick a filter for ideas. We'll search every shop we cover for real, in-stock results.",
    top: "Top {size}",
    bottom: "Bottom {size}",
    shoe: "Shoe EU {size}",
  ...
  swipe: {
    ...
    save: "Save",
    back: "Back",
    summaryTitleOne: "You saved {count} product",
    summaryTitle: "You saved {count} products",
...
export const de: Dict = {
  ...
  search: {
    ...
    liveResults: "{total} Produkte für „{query}“ gefunden",
    ...
    introBody:
      "Beschreibe ein Teil mit deinen eigenen Worten oder wähle einen Filter für Ideen. Wir durchsuchen jeden Shop, den wir abdecken, nach echten, verfügbaren Ergebnissen.",
    top: "Oberteil {size}",
    bottom: "Hose {size}",
    shoe: "Schuh EU {size}",
    budget: "Budget €{amount}",
  ...
  swipe: {
    ...
    save: "Speichern",
    back: "Zurück",
    summaryTitleOne: "Du hast {count} Produkt gespeichert",
    summaryTitle: "Du hast {count} Produkte gespeichert",
    goToFavorites: "Zu den Favoriten",
    noResults: "Keine Ergebnisse gefunden. Versuche eine andere Suche.",
    saveFailed: "Konnte nicht gespeichert werden. Bitte versuche es erneut.",
  },
  favoritesPage: {
...
export const pt: Dict = {
  ...
  search: {
    ...
    liveResults: "{total} produtos encontrados para “{query}”",
    searching: "Buscando…",
    ...
    introBody:
      "Descreva uma peça com suas próprias palavras, ou escolha um filtro para ideias. Vamos buscar resultados reais e disponíveis em cada loja que cobrimos.",
    top: "Cima {size}",
    bottom: "Baixo {size}",
  ...
  swipe: {
    ...
    save: "Salvar",
    back: "Voltar",
    summaryTitleOne: "Você salvou {count} produto",
    summaryTitle: "Você salvou {count} produtos",
